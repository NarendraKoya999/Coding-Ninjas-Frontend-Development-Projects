...
const menuItems = [
  ...
  { id: 11, title: "Iced Coffee", category: "beverages", price: "$4", description: "Chilled coffee served with ice and cream", img: "https://media.istockphoto.com/photos/iced-coffee-in-a-glass-with-a-straw-picture-id1261624163?b=1&s=170667a&w=0&k=20&c=ItUVpbetBvrKaKcJySbepwehwa2JIJjSOqzHulpvJY0=" },
...
function generateMenuItems(items) {
  ...
  items.forEach(item => {
    const cardHtml = `
      <div class="col-md-4 col-sm-6 mb-4 menu-item" data-category="${item.category}">
        <div class="card">
...
// Initial call to generate all menu items
